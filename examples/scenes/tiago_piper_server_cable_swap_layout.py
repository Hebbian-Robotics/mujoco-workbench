...
Every dimension, offset, and derived anchor used by `examples/scenes/tiago_piper_server_cable_swap.py`
...
class DataCenterLayout:
    """Single source of truth for `examples/scenes/tiago_piper_server_cable_swap.py`'s geometry.
...
# -----------------------------------------------------------------------------
# These keep `examples/scenes/tiago_piper_server_cable_swap.py` readable: instead of
