...
style chassis parked in front of a 19" 42U rack. The high-level layout is:
...
from examples.robots.mobile_aloha import (
    BASE_X_JOINT_NAME,
    BASE_Y_JOINT_NAME,
    BASE_YAW_JOINT_NAME,
    LEFT_ARM_MOUNT_SITE,
...
from examples.robots.ur10e import load_ur10e_with_gripper
from examples.scenes.mobile_aloha_ur10e_server_swap_layout import (
    BASE_HOME_POSE,
    HOME_ARM_Q_BY_SIDE,
    IK_SEED_Q,
    LAYOUT,
...
# Dimensions live in `DataCenterLayout` (examples/scenes/mobile_aloha_ur10e_server_swap_layout.py).
    ...
    for side in ARM_PREFIXES:
        ...
        if mount_site is None:
            raise RuntimeError(
                ...
                "did examples/robots/mobile_aloha.py change site names?"
            )
