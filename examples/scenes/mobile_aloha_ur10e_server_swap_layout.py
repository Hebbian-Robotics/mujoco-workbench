...
coordinates. Robot chassis geometry lives in `examples/robots/mobile_aloha.py`.
...
from mujoco_workbench.scene_base import JointConfig, Position3, TaskPhase
...
class DataCenterLayout:
    """Single source of truth for `examples/scenes/mobile_aloha_ur10e_server_swap.py` geometry.

    Robot-base geometry lives in `examples/robots/mobile_aloha.py`. World-frame
