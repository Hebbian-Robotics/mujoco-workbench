...
from mujoco_workbench.scene_check import AttachmentConstraint
...
class _PhasePoseCapture:
    ...
    Mirror of the server-swap layout's `_PhasePose`, but mutable and using raw
    numpy arrays — this is the in-flight cache, not the
...
class TeleopController:
        ...
        with self.server.gui.add_folder("Teleop"):
            ...
            print_phase_homes_btn = self.server.gui.add_button(
                ...
                hint=(
                    ...
                    "_PhaseHomes.by_phase mapping for the server-swap layout module"
                ),
            )
    ...
    def print_base_pose(self) -> None:
        ...
        factory in the server-swap layout module.
        """
        base_sliders = self._base_sliders_or_none()
        if base_sliders is None:
            return
    ...
    def print_home_q(self) -> None:
        ...
        default factory in the server-swap layout module.
        """
